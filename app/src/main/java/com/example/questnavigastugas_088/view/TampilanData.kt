...
import com.example.questnavigastugas_088.R
...
fun TampilData(
    ...
    val items = listOf(
        Pair(stringResource(id = R.string.nama_lengkap), "Dzakiyah Al Zahrani"),
        Pair(stringResource(id = R.string.jenis_kelamin), "Perempuan"),
        Pair(stringResource(id = R.string.status), "Lajang"),
